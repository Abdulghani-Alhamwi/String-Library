...

{
    ...
    cout << "Number of words: " <<
        clsString::CountWords("Abdulghani AlHamwi") << endl;
    ...
    cout << "Capital Letters count : "
        << clsString::CountLetters("Ali Kassab", clsString::CapitalLetters)
        << endl << endl;
    ...
    //Tirms
    String3.Value = "    Abdulghani AlHamwi     ";
    ...
    //Joins
    vector<string> vString1 = { "Mohammed","Ali","Fadi","Maher" };
